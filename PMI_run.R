...
# Call function 'PMI_grnn_framework_2' from file "PMI.R" to compute best inputs
# based on PMI. Output is written to file within this function
PMI_grnn_framework(x, y, iter = min(ncol(x), 30),
                   outfile = paste(out.dir, fn, "_GRNN_out.csv", sep = ""),
                   mifile = paste(out.dir, fn, "_GRNN_mi.txt", sep = ""),
                   ybin = FALSE, silent = FALSE)
